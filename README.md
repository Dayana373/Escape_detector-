...
### 📊 Превью результатов
<img src="screenshots/correlation_heatmap.png" width="900" alt="Корреляционная матрица">

<img src="screenshots/satisfaction_kde.jpg" width="900" alt="Распределение удовлетворенности">

<img src="screenshots/workload_bar.jpg" width="900" alt="Загруженность по отделам">
